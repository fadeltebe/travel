...
class RouteSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $routes = [
            ...
            // Palu <-> Luwuk
            ['origin_agent_id' => $palu->id, 'destination_agent_id' => $luwuk->id, 'distance_km' => 610, 'estimated_duration_minutes' => 840, 'base_price' => 250000, 'is_active' => true],
            ['origin_agent_id' => $luwuk->id, 'destination_agent_id' => $palu->id, 'distance_km' => 610, 'estimated_duration_minutes' => 840, 'base_price' => 250000, 'is_active' => true],
        ];
