        ...
        <form wire:submit="login" class="flex flex-col flex-1">
            ...
            <div class="bg-white rounded-[14px] border border-gray-200 shadow-sm overflow-hidden mb-4">
                ...
                <div x-data="{ show: false }" class="relative group">
                    ...
                    <button type="button" @click="show = !show"
                        class="absolute right-0 top-0 bottom-0 pr-5 flex items-center text-[#004a8b] focus:outline-none focus:ring-0">
                        <!-- Eye Icon -->
            ...
            <div class="flex justify-end mb-8">
                <a href="{{ route('password.request') }}" wire:navigate
                    class="text-sm font-bold text-[#004a8b] hover:text-blue-800 underline decoration-2 underline-offset-4 decoration-[#004a8b]/30 hover:decoration-[#004a8b]">
