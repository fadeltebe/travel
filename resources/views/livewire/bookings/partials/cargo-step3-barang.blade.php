<div class="space-y-4">
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-3 relative">
        ...
        <div class="space-y-2 mt-1">
            <input type="text" wire:model="items.{{ $index }}.item_name" class="w-full px-4 py-2 rounded-lg border-gray-200 text-sm font-bold text-gray-900" placeholder="Nama Barang / Kemasan (contoh: Dos Coklat)">
