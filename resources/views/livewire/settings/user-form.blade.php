...
on(['openEditUser' => function ($userId) {
    $this->resetValidation();
            ...
            <div 
                ...
                <div class="p-6 overflow-y-auto custom-scrollbar flex-1 relative z-10 bg-white">
                    <form wire:submit="save" id="userForm" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="name" class="w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm" placeholder="Contoh: Budi Santoso">
                        ...
                        <div>
                            ...
                            <input type="email" wire:model="email" class="w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm" placeholder="Contoh: budi@travel.com">
                            @error('email') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        {{-- Password --}}
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-1.5">Password {{ $userId ? '(Kosongkan jika tidak diubah)' : '' }}</label>
                            <input type="password" wire:model="password" class="w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm" placeholder="Minimal 8 karakter">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select wire:model.live="role" class="w-full pl-4 pr-10 py-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm appearance-none">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select wire:model="agent_id" class="w-full pl-4 pr-10 py-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm appearance-none">
                            ...
                            @error('agent_id') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        @endif
                ...
                <div class="p-4 sm:p-6 border-t border-gray-100 bg-gray-50 relative z-10 shrink-0">
                    <div class="flex gap-3">
                        ...
                        <button type="submit" form="userForm" class="flex-1 py-3 px-4 rounded-xl text-white font-bold text-sm bg-pink-600 hover:bg-pink-700 active:scale-95 shadow-lg shadow-pink-200 transition-all flex items-center justify-center gap-2">
