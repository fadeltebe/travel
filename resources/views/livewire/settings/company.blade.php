    ...
    <x-layouts.app title="Profil Perusahaan">
        <div class="max-w-3xl mx-auto px-4 py-8">
            ...
            <div class="mb-8 flex items-center gap-4">
                <a href="{{ route('settings.index') }}" wire:navigate class="p-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Tentukan bagaimana cara agen mencetak tiket dan menggunakan mutasi dompet token.</p>
                        </div>
                    </div>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                        <label class="flex items-start p-4 border-2 rounded-xl cursor-pointer transition-all {{ $billing_mode === 'centralized' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300' }}">
                            <div class="flex-1">
                                <p class="font-bold {{ $billing_mode === 'centralized' ? 'text-orange-700' : 'text-gray-700' }}">Terpusat (1 Dompet Bos)</p>
                                <p class="text-xs text-gray-500 mt-1">Semua agen memotong saldo dari Dompet Utama Anda setiap kali menerbitkan manifest/tiket.</p>
                            </div>
                            <input type="radio" wire:model="billing_mode" value="centralized" class="mt-1 w-5 h-5 text-orange-600 border-gray-300 focus:ring-orange-500">
                        </label>
                        <label class="flex items-start p-4 border-2 rounded-xl cursor-pointer transition-all {{ $billing_mode === 'per_agent' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300' }}">
                            <div class="flex-1">
                                <p class="font-bold {{ $billing_mode === 'per_agent' ? 'text-orange-700' : 'text-gray-700' }}">Mandiri (Per Agen)</p>
                                <p class="text-xs text-gray-500 mt-1">Masing-masing agen memiliki dompet terpisah. Agen harus top-up mandiri atau disubsidi agar bisa cetak tiket.</p>
                            </div>
                            <input type="radio" wire:model="billing_mode" value="per_agent" class="mt-1 w-5 h-5 text-orange-600 border-gray-300 focus:ring-orange-500">
                        </label>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-full md:col-span-1">
                            ...
                            <input type="text" wire:model="code" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="col-span-full">
                            ...
                            <input type="text" wire:model="npwp" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div class="col-span-full">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Alamat Lengkap</label>
                            <textarea wire:model="address" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                        </div>
                    </div>
