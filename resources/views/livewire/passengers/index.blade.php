...
$passengers = computed(function () {
    ...
    return Passenger::query()
        ->with([
            'booking.schedule.route.originAgent',
            'booking.schedule.route.destinationAgent'
        ])
...
<div>
    <x-layouts.app title="Daftar Penumpang">
        {{-- Header --}}
        <div class="relative overflow-hidden text-white mx-4 rounded-2xl px-4 pt-5 pb-10" style="background: linear-gradient(160deg, #10B981 0%, #059669 50%, #047857 100%);">
                    ...
                    <div class="flex items-start gap-3 p-3 pb-2 pr-24">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[10px] text-gray-500 font-semibold mt-0.5 flex items-center gap-1">
                                ...
                                <span class="font-black text-gray-800 ml-1">{{ $passenger->booking->booking_code ?? 'N/A' }}</span>
                            </p>
                        </div>
                    </div>
