    ...
    <x-layouts.app title="Manajemen Cabang & Agen">
        <div class="max-w-3xl mx-auto pb-28">
                ...
                <div class="mt-5 relative z-10">
                    <div class="relative">
                        <input type="text" wire:model.live.debounce.300ms="search"
                            placeholder="Cari nama, kota atau kode..."
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center gap-1.5 mt-0.5 text-xs text-gray-500">
                                        <span
                                            class="font-mono text-[10px] bg-gray-100 px-1.5 py-0.5 rounded text-gray-600">{{ $agent->code }}</span>
                                        <span>&bull;</span>
                                        <span class="truncate">{{ $agent->city }}</span>
                                    </div>
                                    <div class="flex flex-wrap items-center gap-1.5 mt-2">
                                        <span
                                            class="text-[10px] font-bold bg-amber-50 text-amber-600 px-2 py-0.5 rounded-lg flex items-center gap-1">
            ...
            <button wire:click="openCreate"
                ...
                style="bottom: calc(72px + env(safe-area-inset-bottom)); background: linear-gradient(135deg, #10b981, #047857); box-shadow: 0 4px 20px rgba(16,185,129,0.45);"
                title="Tambah Agen">
